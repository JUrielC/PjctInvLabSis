...
router.post('/', body('nombre_tipo').isLength({max:35}),body('descripcion').isLength({max:255}), post_tipoHerramienta);

router.get('/', get_tipoHerramienta);

router.put('/', body('nombre_tipo').isLength({max:35}),body('descripcion').isLength({max:255}), put_tipoHerramienta);
